                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Container(
                        width: 250,
                        child: AppText(
                          text: "Mountain hikes give you an incredebile sense of freedom along with endurance test",
                      ...
                      List.generate(3, (indexDots){
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: index==indexDots?Color(0xFFababab) : Color(0xFFababab).withOpacity(0.3),
                          ),
                        );
                      }),
